...
public class Parser implements ParserConstants {
  ...
  final public void parse() throws ParseException, SynthColumnException {
    expression();
    jj_consume_token(0);
  }

  final public void expression() throws ParseException, SynthColumnException {
    term();
    label_1:
    while (true) {
  ...
  final public void term() throws ParseException, SynthColumnException {
    factor();
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public void factor() throws ParseException, SynthColumnException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case WORD:
      column();
      break;
  ...
  final public void column() throws ParseException, SynthColumnException {
String tmp=null;
String result="";
    label_3:
    while (true) {
...
//    throw new Error("Missing return statement in function");
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x60,0x60,0x180,0x180,0x1a00,0x800,};
   }
