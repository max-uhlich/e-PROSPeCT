 ...
 * line }</li> </ul>
 */
public class SliderBarMovie extends FocusPanel implements ResizableWidget,
  ...
  public static interface LabelFormatter {
     ...
     */
    String formatLabel(SliderBarMovie slider, double value);
  }

  /**
   * An {@link ImageBundle} that provides images for {@link SliderBarMovie}.
   */
   ...
   */
  public SliderBarMovie(double minValue, double maxValue) {
  ...
  public int getLineWidth() {
	 return DOM.getElementPropertyInt(lineElement, "offsetWidth");
  }
}
