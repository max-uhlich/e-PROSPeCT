...
public class SliderBar extends FocusPanel implements ResizableWidget,
  ...
  private void drawTicks() {
    ...
    if (numTicks > 0) {
      ...
      for (int i = 0; i <= numTicks; i++) {
        ...
        DOM.setStyleAttribute(tick, "top", "12px");
        DOM.setStyleAttribute(tick, "height", "18px");
  ...
  public void setSliderZIndex(int zIndex) {
	  knobImage.getElement().getStyle().setZIndex(zIndex);
  }
  
  public void setPositionStyle(String position) {
