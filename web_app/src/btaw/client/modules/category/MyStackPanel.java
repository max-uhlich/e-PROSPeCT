 ...
 */
public class MyStackPanel extends ComplexPanel implements InsertPanel.ForIsWidget {
  ...
  public String getStackText(int index) {
	    ...
	    Element tdWrapper = DOM.getChild(DOM.getChild(body, index * 2), 0);
	    Element headerElem = DOM.getFirstChild(tdWrapper);
	    return getHeaderTextElem(headerElem).getInnerText();
	  }
