 ...
 * </pre>
 */
public class CustomTabLayoutPanel extends ResizeComposite implements HasWidgets,
  ...
  private class Tab extends SimplePanel {
    ...
    public boolean remove(Widget w) {
      ...
      if (replacingWidget || index < 0) {
        ...
        return CustomTabLayoutPanel.this.remove(index);
      }
    }
  ...
  private class TabbedDeckLayoutPanel extends DeckLayoutPanel {
    ...
    public boolean remove(Widget w) {
       ...
       */
      return CustomTabLayoutPanel.this.remove(w);
    }
   ...
   */
  public CustomTabLayoutPanel(double barHeight, Unit barUnit, PushButton minimize, PushButton maximize) {
    LayoutPanel panel = new LayoutPanel();
    initWidget(panel);

    HorizontalPanel mainBar = new HorizontalPanel();
    mainBar.setWidth("100%");
    mainBar.setHorizontalAlignment(HorizontalPanel.ALIGN_LEFT);
    mainBar.add(tabBar);
    mainBar.setHorizontalAlignment(HorizontalPanel.ALIGN_RIGHT);
    
    HorizontalPanel buttonBar = new HorizontalPanel();
    buttonBar.add(minimize);
    buttonBar.add(maximize);
    
    buttonBar.getElement().getStyle().setPaddingRight(3, Unit.PX);
    buttonBar.getElement().getStyle().setPaddingTop(6, Unit.PX);
    mainBar.add(buttonBar);
    
    // Add the tab bar to the panel.
    panel.add(mainBar);
    panel.setWidgetLeftRight(mainBar, 0, Unit.PX, 0, Unit.PX);
    panel.setWidgetTopHeight(mainBar, 0, Unit.PX, barHeight, barUnit);
    panel.setWidgetVerticalPosition(mainBar, Alignment.END);
    ...
    mainBar.setStyleName("gwt-TabLayoutPanelTabs");
    tabBar.setWidth("100%");
